...
describe("roundtrip message conversion", () => {
  test3("text message AGUI -> GQL -> AGUI", () => {
    const aguiMsg = {
      id: "user-1",
      role: "user",
      content: "Hello!"
  ...
  test3("text message GQL -> AGUI -> GQL", () => {
  ...
  test3("tool message AGUI -> GQL -> AGUI", () => {
    const aguiMsg = {
      id: "tool-1",
      role: "tool",
      content: "Tool result",
  ...
  test3("tool message GQL -> AGUI -> GQL", () => {
  ...
  test3("agent state GQL -> AGUI -> GQL", () => {
  ...
  test3("action execution with render function roundtrip", () => {
  ...
  test3("image message AGUI -> GQL -> AGUI (assistant and user)", () => {
  ...
  test3("roundtrip conversion verifies correct property distribution for wildcard actions", () => {
    const mockRender = vi.fn(
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=roundtrip-conversion.test.js.map