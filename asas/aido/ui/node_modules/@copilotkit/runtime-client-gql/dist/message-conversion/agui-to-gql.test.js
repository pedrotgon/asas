...
describe("agui-to-gql", () => {
  describe("aguiTextMessageToGQLMessage", () => {
    ...
    test3("should convert user message", () => {
      const aguiMessage = {
        id: "user-message-id",
        role: "user",
        content: "User input"
    ...
    test3("should throw error for unsupported role", () => {
      const aguiMessage = {
        id: "tool-message-id",
        role: "tool",
    ...
    test3("should handle undefined content", () => {
      const aguiMessage = {
        id: "assistant-message-id",
        role: "assistant",
        content: void 0
  ...
  describe("aguiToolCallToGQLActionExecution", () => {
    test3("should convert function tool call to action execution message", () => {
      const toolCall = {
        id: "tool-call-id",
        type: "function",
        function: {
    ...
    test3("should throw error for unsupported tool call type", () => {
      const toolCall = {
        id: "tool-call-id",
  ...
  describe("aguiToolMessageToGQLResultMessage", () => {
    test3("should convert tool message to result message", () => {
      const aguiMessage = {
        id: "tool-message-id",
        role: "tool",
    ...
    test3("should throw error for non-tool message", () => {
      const aguiMessage = {
        id: "assistant-message-id",
        role: "assistant",
        content: "Assistant response"
    ...
    test3("should throw error for tool message without toolCallId", () => {
      const aguiMessage = {
        id: "tool-message-id",
        role: "tool",
        content: "Tool execution result"
  ...
  describe("aguiToGQL", () => {
    ...
    test3("should convert an array of text messages including user messages", () => {
      const aguiMessages = [
        {
          id: "user-1",
          role: "user",
    ...
    test3("should handle a mix of message types including user messages", () => {
      const aguiMessages = [
        {
          id: "user-1",
          role: "user",
  ...
  describe("aguiMessageWithRenderToGQL", () => {
    test3("should handle assistant message with tool calls and render function", () => {
    ...
    test3("should handle assistant message with render function but no tool calls", () => {
    ...
    test3("should handle regular assistant message without render function", () => {
      const aguiMessage = {
        id: "assistant-1",
        role: "assistant",
    ...
    test3("should handle multiple tool calls with render functions", () => {
    ...
    test3("should verify render function receives correct props including name", () => {
  ...
  describe("aguiImageMessageToGQLMessage", () => {
    test3("should throw error for missing format or bytes in image message", () => {
      const aguiMessage = {
        id: "image-1",
        role: "assistant",
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=agui-to-gql.test.js.map