...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b = (_a3 = this._userConfig) == null ? void 0 : _a3.toFake) == null ? void 0 : _b.includes("nextTick")) && isChildProcess())
...
function validateImageFormat(format4) {
  return VALID_IMAGE_FORMATS.includes(format4);
}
...
describe("message-conversion", () => {
  describe("gqlTextMessageToAGUIMessage", () => {
    test3("should convert developer message", () => {
    ...
    test3("should convert system message", () => {
      const gqlMessage = new TextMessage({
    ...
    test3("should convert assistant message", () => {
      const gqlMessage = new TextMessage({
    ...
    test3("should throw error for unknown role", () => {
      const gqlMessage = new TextMessage({
  ...
  describe("gqlResultMessageToAGUIMessage", () => {
    test3("should convert result message to tool message", () => {
  ...
  describe("gqlToAGUI", () => {
    test3("should convert an array of text messages", () => {
      const gqlMessages = [
        new TextMessage({
          id: "dev-1",
          content: "Hello",
    ...
    test3("should handle agent state messages", () => {
    ...
    test3("should handle action execution messages with parent messages", () => {
    ...
    test3("should handle multiple action execution messages for the same parent", () => {
      const assistantMsg = new TextMessage({
        id: "assistant-1",
    ...
    test3("should not add toolCalls to non-assistant messages", () => {
    ...
    test3("should handle action execution messages without actions context", () => {
      const actionExecMsg = new ActionExecutionMessage({
        id: "action-1",
        name: "testAction",
        arguments: { param: "value" }
    ...
    test3("should handle action execution messages with actions context and render functions", () => {
      const actionExecMsg = new ActionExecutionMessage({
        id: "action-1",
        name: "testAction",
        arguments: { param: "value" },
    ...
    test3("should provide correct status in generativeUI function props", () => {
      var _a3, _b;
      const actionExecMsg = new ActionExecutionMessage({
        id: "action-1",
        name: "testAction",
      ...
      const result = gqlToAGUI([actionExecMsg], actions);
      (_b = (_a3 = result[0]).generativeUI) == null ? void 0 : _b.call(_a3);
    ...
    test3("should handle action not found in actions context", () => {
      const actionExecMsg = new ActionExecutionMessage({
        id: "action-1",
        name: "unknownAction",
        arguments: { param: "value" }
    ...
    test3("should handle agent state messages with coAgentStateRenders", () => {
      var _a3, _b;
    ...
    test3("should handle agent state messages without coAgentStateRenders", () => {
      const agentStateMsg = new AgentStateMessage({
        id: "agent-state-1",
        agentName: "testAgent",
        state: { status: "running", data: "test data" },
    ...
    test3("should handle agent state messages with agent not found in coAgentStateRenders", () => {
      const agentStateMsg = new AgentStateMessage({
        id: "agent-state-1",
    ...
    test3("should handle user role messages", () => {
    ...
    test3("should handle mixed message types including agent state messages", () => {
  ...
  describe("gqlImageMessageToAGUIMessage", () => {
    test3("should throw error for invalid image format", () => {
    ...
    test3("should convert valid image message", () => {
    ...
    test3("should convert valid user image message", () => {
      const validImageMsg = new ImageMessage({
        id: "img-user-1",
        format: "jpeg",
    ...
    test3("should convert valid assistant image message", () => {
      const validImageMsg = new ImageMessage({
        id: "img-assistant-1",
        format: "png",
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=gql-to-agui.test.js.map